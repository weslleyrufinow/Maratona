...
char horizontal(int l, int r, int c, int matriz[TAM][TAM], char &OK){
    ...
    for(i=c; i<l; i++){    
        if(matriz[r][i]==1){//Se a posição já estiver marcada, um barco passou por cima do outro, eh invalido
            OK='N';
            return OK;
        }
        matriz[r][i]=1;//Marco a posicao do barco na matriz
    }
return OK;}
char vertical(int l, int r, int c, int matriz[TAM][TAM], char &OK){
    ...
    for(i=r; i<l; i++){
        if(matriz[i][c]==1){//Se a posição já estiver marcada, um barco passou por cima do outro, eh invalido
            OK='N';
            return OK;
        }
        matriz[i][c]=1;//Marco a posicao do barco na matriz
    }
return OK;}
...
g++ -g -O2 -std=gnu11 -static -lm 2020B.cpp -o 2020B; ./2020B

g++ B2020.cpp -o B2020 && ./Script.sh
g++ B2020.cpp -o B2020 && ./ScriptTest.sh
*/